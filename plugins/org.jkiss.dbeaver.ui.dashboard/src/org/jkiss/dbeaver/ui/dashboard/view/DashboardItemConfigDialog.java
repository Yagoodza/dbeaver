...
public class DashboardItemConfigDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.config_dialog_dashboards_title + dashboardContainer.getDashboardTitle() + UIDashboardMessages.config_dialog_dashboards_bracket, null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.config_dialog_dashboards_group_info, 4, GridData.FILL_HORIZONTAL, 0);

            //UIUtils.createLabelText(infoGroup, "ID", dashboardConfig.getDashboardDescriptor().getId(), SWT.BORDER | SWT.READ_ONLY);
            UIUtils.createLabelText(infoGroup, UIDashboardMessages.config_dialog_dashboards_label_name, dashboardConfig.getDashboardDescriptor().getName(), SWT.BORDER | SWT.READ_ONLY)
                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));

            UIUtils.createControlLabel(infoGroup, UIDashboardMessages.config_dialog_dashboards_label_description).setLayoutData(new GridData(GridData.VERTICAL_ALIGN_BEGINNING));
            ...
            if (SHOW_QUERIES_BUTTON) {
                ...
                queriesButton.setText(UIDashboardMessages.config_dialog_dashboards_button_queries);
                    ...
                    public void widgetSelected(SelectionEvent e) {
                        ...
                        if (serviceSQL != null) {
                            serviceSQL.openSQLViewer(
                                ...
                                UIDashboardMessages.config_dialog_dashboards_context,
                                UIIcon.SQL_SCRIPT,
                                sql.toString(),
                                false, false);
                        }
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.config_dialog_dashboards_group_update, 2, GridData.FILL_HORIZONTAL, 0);

            Text updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.config_dialog_dashboards_label_update, String.valueOf(dashboardConfig.getUpdatePeriod()), SWT.BORDER, new GridData(GridData.FILL_HORIZONTAL));
            ...
            Text maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.config_dialog_dashboards_label_items, String.valueOf(dashboardConfig.getMaxItems()), SWT.BORDER, new GridData(GridData.FILL_HORIZONTAL));
...
*/
        ...
        {
            Group viewGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.config_dialog_dashboards_group_view, 2, GridData.FILL_HORIZONTAL, 0);

            Combo typeCombo = UIUtils.createLabelCombo(viewGroup, UIDashboardMessages.config_dialog_dashboards_label_view, UIDashboardMessages.config_dialog_dashboards_label_tip_view, SWT.BORDER | SWT.READ_ONLY);
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.config_dialog_dashboards_label_legend, UIDashboardMessages.config_dialog_dashboards_label_tip_legend, dashboardConfig.isLegendVisible(), 2)
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.config_dialog_dashboards_label_grid, UIDashboardMessages.config_dialog_dashboards_label_tip_grid, dashboardConfig.isGridVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.config_dialog_dashboards_label_domain, UIDashboardMessages.config_dialog_dashboards_label_tip_domain, dashboardConfig.isDomainTicksVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
            ...
            UIUtils.createCheckbox(viewGroup, UIDashboardMessages.config_dialog_dashboards_label_range, UIDashboardMessages.config_dialog_dashboards_label_tip_range, dashboardConfig.isDomainTicksVisible(), 2)
                .addSelectionListener(new SelectionAdapter() {
                    @Override
                    public void widgetSelected(SelectionEvent e) {
...
*/
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        createButton(parent, IDialogConstants.CANCEL_ID, UIDashboardMessages.config_dialog_dashboards_button_configuration, false).addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
