...
public class DashboardEditDialog extends BaseDialog {
    ...
    {
        super(shell, UIDashboardMessages.edit_dialog_dashboards_title + dashboardDescriptor.getName() + UIDashboardMessages.edit_dialog_dashboards_bracket, null);
    ...
    protected Composite createDialogArea(Composite parent)
    {
        ...
        if (readOnly) {
            UIUtils.createInfoLabel(composite, UIDashboardMessages.edit_dialog_dashboards_label_info_main);
        }

        {
            Group infoGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.edit_dialog_dashboards_group_main, 4, GridData.FILL_HORIZONTAL, 0);

            idText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_ID, dashboardDescriptor.getId(), SWT.BORDER | baseStyle);
            ...
            nameText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_name, dashboardDescriptor.getName(), SWT.BORDER | baseStyle);
            ...
            {
                UIUtils.createControlLabel(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_database);
                ...
                UIUtils.createPushButton(dbSelectorPanel, UIDashboardMessages.edit_dialog_dashboards_button_select, null, new SelectionAdapter() {
                    @Override
...
//                .setLayoutData(new GridData(GridData.FILL, GridData.BEGINNING, true, false, 3, 1));
            dataTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_data_type, UIDashboardMessages.edit_dialog_dashboards_label_tip_data_type, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            calcTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_calc_type, UIDashboardMessages.edit_dialog_dashboards_label_tip_calc_type, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            valueTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_value_type, UIDashboardMessages.edit_dialog_dashboards_label_tip_value_type, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            intervalCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_interval, UIDashboardMessages.edit_dialog_dashboards_label_tip_interval, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            fetchTypeCombo = UIUtils.createLabelCombo(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_fetch_type, UIDashboardMessages.edit_dialog_dashboards_label_tip_fetch_type, SWT.BORDER | SWT.DROP_DOWN | SWT.READ_ONLY);
            ...
            descriptionText = UIUtils.createLabelText(infoGroup, UIDashboardMessages.edit_dialog_dashboards_label_description, CommonUtils.notEmpty(dashboardDescriptor.getDescription()), SWT.BORDER | SWT.MULTI | SWT.WRAP | SWT.V_SCROLL | baseStyle);
        ...
        {
            Group sqlGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.edit_dialog_dashboards_group_queries, 1, GridData.FILL_BOTH, 0);
            queryText = new Text(sqlGroup, SWT.BORDER | SWT.MULTI | SWT.V_SCROLL | SWT.WRAP | baseStyle);
            GridData gd = new GridData(GridData.FILL_BOTH);
            gd.heightHint = 100;
            gd.widthHint = 400;
            queryText.setLayoutData(gd);
            UIUtils.createInfoLabel(sqlGroup, UIDashboardMessages.edit_dialog_dashboards_label_info_queries);
            ...
            if (dashboardDescriptor.getMapQuery() != null) {
                ...
                if (!ArrayUtils.isEmpty(dashboardDescriptor.getMapKeys())) {
                    sql.append(UIDashboardMessages.edit_dialog_dashboards_descriptor_keys).append(Arrays.toString(dashboardDescriptor.getMapKeys())).append(lineSeparator);
                }
                if (!ArrayUtils.isEmpty(dashboardDescriptor.getMapLabels())) {
                    sql.append(UIDashboardMessages.edit_dialog_dashboards_descriptor_labels).append(Arrays.toString(dashboardDescriptor.getMapLabels())).append(lineSeparator);
                }
            }
        ...
        {
            Group updateGroup = UIUtils.createControlGroup(composite, UIDashboardMessages.edit_dialog_dashboards_group_rendering, 2, GridData.FILL_HORIZONTAL, 0);

            viewTypeCombo = UIUtils.createLabelCombo(updateGroup, UIDashboardMessages.edit_dialog_dashboards_label_view, UIDashboardMessages.edit_dialog_dashboards_label_tip_view, SWT.BORDER | SWT.READ_ONLY);
            ...
            updatePeriodText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.edit_dialog_dashboards_label_update_period, String.valueOf(dashboardDescriptor.getUpdatePeriod()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
            maxItemsText = UIUtils.createLabelText(updateGroup, UIDashboardMessages.edit_dialog_dashboards_label_maximum_items, String.valueOf(dashboardDescriptor.getMaxItems()), SWT.BORDER | baseStyle, new GridData(GridData.FILL_HORIZONTAL));
